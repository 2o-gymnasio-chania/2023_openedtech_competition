...
### Αρχική ιδέα
<img src="images/epideixi_robot_1_s.jpg" width=80%>
...
<img src="images/schediasi_1.jpg" width=80%>
...
<img src="images/schediasi_2.jpg" width=80%>
...
<img src="images/papoutsi.jpg" width=80%>
...
<img src="images/energeia_vrochis.jpg" width=80%>
...
<img src="images/aftonoma_fyta.jpg" width=80%>
...
<img src="images/schedio_1.jpg" width=80%>
...
<img src="images/schedio_2.jpg" width=80%>
...
<img src="images/wheel_alert_1.jpg" width=80%>
...
### Λίστα εξοπλισμού ###
1. [Ρομποτικός ελεγκτής arduino Uno](https://grobotronics.com/arduino-uno-rev3.html) - 30€,
2. [Αισθητήρες υπερύθρων](https://grobotronics.com/infrared-proximity-sensor-sharp-gp2y0a21yk.html) - 12€,
3. [Ηλιακός συλλέκτης](https://grobotronics.com/solar-cell-10w-350x250mm.html) - 13€,
4. [συσσωρευτής](https://grobotronics.com/lead-acid-battery-12v-4.5ah.html) - 13€,
5. [φορτιστής]() = (https://grobotronics.com/solar-battery-charger-regulator-10a-dual-usb.html) - 9€ και
6. καλώδια διάφορων ειδών και πλακέτες δοκιμών - 10€.

### Ενδεικτικό κόστος ###
Εντός των παρενθέσεων στη λίστα προτεινόμενου εξοπλισμού αναφέρεται το ενδεικτικό κόστος για το κάθε εξάρτημα του ρομπότ. Το συνολικό κόστος περιορίστηκε στα **90€**.
...
<img src="images/ir.jpg" width=80%>

*Τοποθέτηση του αισθητήρα υπερύθρων*

<img src="images/kataskeyi.jpg" width=80%>
<img src="images/kataskeyi_2.jpg" width=80%>
...
<img src="images/algorithmos.jpg" width=80%>

*Σύνταξη του αλγορίθμου - αρχικές ιδέες*

<img src="images/algorithmos_2.jpg" width=80%>

*Σύνταξη του αλγορίθμου - σχεδίαση του διαγράμματος ροής*

<img src="images/algorithmos_3.jpg" width=80%>
...
<img src="images/kataskeyi_3.jpg" width=80%>
<img src="images/kataskeyi_4.jpg" width=80%>
...
- [https://openedtech.ellak.gr/robotics2023/2o-gimnasio-chanion-wheel-alert](https://openedtech.ellak.gr/robotics2023/2o-gimnasio-chanion-wheel-alert/)
...
<img src="OER_canvas/OER_canvas_Wheel_Alert.jpg" width=80%>
